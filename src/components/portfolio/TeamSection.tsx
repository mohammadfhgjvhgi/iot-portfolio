...
const FOUNDERS: Founder[] = [
  {
    ...
    role: {
      ar: "مؤسس ومهندس أنظمة مدمجة",
      en: "Co-Founder & Embedded Systems Engineer",
    },
    bio: {
      ar: "متخصص في تصميم أنظمة التحكم والمعالجة المحلية (Edge Computing). أبني المنطق البرمجي الذي يعمل على المتحكمات الدقيقة بمنهجية هندسية تضمن الأمان والاستقرار. خبرة واسعة في معمارية الأنظمة متعددة المعالجات والاتصال التسلسلي.",
      en: "Specializing in control systems design and edge computing. Building software logic for microcontrollers with engineering methodology ensuring safety and stability. Extensive experience in multi-processor architectures and serial communication.",
    },
    skills: ["Arduino", "ESP32", "C/C++", "Firebase", "Hardware Design"],
    color: "#00ff66",
    glowColor: "#00ff6640",
    avatarIcon: <Microchip className="h-8 w-8" />,
  },
  {
    name: { ar: "محمد عقيلي", en: "Mohammad Aqli" },
    role: {
      ar: "مؤسس ومطور إنترنت الأشياء",
      en: "Co-Founder & IoT Developer",
    },
    bio: {
      ar: "متخصص في ربط الأنظمة المدمجة بالسحابة وتطوير واجهات التحكم عن بُعد. خبرة في بناء الجسور البرمجية بين العتاد والويب عبر Python وFirebase. شغوف بتحويل المشاريع الأكاديمية إلى منتجات حقيقية.",
      en: "Specializing in connecting embedded systems to the cloud and developing remote control interfaces. Expert in building software bridges between hardware and web via Python and Firebase. Passionate about turning academic projects into real products.",
    },
    skills: ["ESP8266", "Python", "Web Development", "Firebase", "Android"],
    color: "#00e5ff",
    glowColor: "#00e5ff40",
